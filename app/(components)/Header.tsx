...
const Navbar = () => {
  ...
  return (
    <AppBar position="static" sx={{ p: 1, backgroundColor: '#333' }} className='mb'>
      <Toolbar className='header_padd' sx={{ justifyContent: 'space-between', pr: 4, pl: 4 }}>
        ...
        <Link href="/SignIn" className='a a_h header_links ' color="inherit">
          Sign In
        </Link>

        <Link href="/SignUp" className='a a_h header_links' color="inherit">
          Sign Up
        </Link>
